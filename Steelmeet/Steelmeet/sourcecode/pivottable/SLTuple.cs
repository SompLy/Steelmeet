...
namespace SpreadsheetLight
{
    internal class SLTuple
    {
        ...
        internal void FromTuple(DocumentFormat.OpenXml.Spreadsheet.Tuple t)
        {
            this.SetAllNull();
        ...
        internal DocumentFormat.OpenXml.Spreadsheet.Tuple ToTuple()
        {
            DocumentFormat.OpenXml.Spreadsheet.Tuple t = new DocumentFormat.OpenXml.Spreadsheet.Tuple();
