...
namespace SpreadsheetLight
{
    ...
    public class SLFont
    {
        ...
        internal void FromFont(DocumentFormat.OpenXml.Spreadsheet.Font f)
        {
            this.SetAllNull();
        ...
        internal DocumentFormat.OpenXml.Spreadsheet.Font ToFont()
        {
            DocumentFormat.OpenXml.Spreadsheet.Font f = new DocumentFormat.OpenXml.Spreadsheet.Font();
        ...
        {
            DocumentFormat.OpenXml.Spreadsheet.Font font = this.ToFont();
