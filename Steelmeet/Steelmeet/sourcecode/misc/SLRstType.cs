...
namespace SpreadsheetLight
{
    ...
    public class SLRstType
    {
        ...
        public void AppendText(string Text, SLFont TextFont)
        {
            ...
            {
                runprops.Append(new DocumentFormat.OpenXml.Spreadsheet.FontFamily() { Val = TextFont.FontFamily.Value });
            }
                        ...
                        if (xrun.RunProperties != null)
                        {
                            using (OpenXmlReader oxrProps = OpenXmlReader.Create(xrun.RunProperties))
                            {
                                while (oxrProps.Read())
                                {
                                    ...
                                    {
                                        xrunColor = (DocumentFormat.OpenXml.Spreadsheet.Color)oxrProps.LoadCurrentElement();
