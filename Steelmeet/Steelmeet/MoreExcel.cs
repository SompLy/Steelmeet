        ...
        public static void exportToExcel(this System.Data.DataTable DataTable, string ExcelFilePath = null)
        {
            try
            {
                ...
                if (DataTable == null || (ColumnsCount = DataTable.Columns.Count) == 0)
                    throw new Exception("ExportToExcel: Null eller tomt Datatable!\n");
                ...
                if (ExcelFilePath != null && ExcelFilePath != "")
                {
                    try
                    {
                        ...
                        Excel.Quit();
                        System.Windows.Forms.MessageBox.Show("Excel fil Sparad! :)");
                    }
                    catch (Exception ex)
                    {
                        throw new Exception("ExportToExcel: Excel fil kunde inte sparas! Kolla filsökväg.\n"
                          + ex.Message);
                    }
                }
