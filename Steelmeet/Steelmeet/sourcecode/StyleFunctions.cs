                    ...
                    while (oxr.Read())
                    {
                        ...
                        else if (oxr.ElementType == typeof(Fonts))
                        {
                            ...
                            using (OpenXmlReader oxrFont = OpenXmlReader.Create((Fonts)oxr.LoadCurrentElement()))
                            {
                                while (oxrFont.Read())
                                {
                                    if (oxrFont.ElementType == typeof(DocumentFormat.OpenXml.Spreadsheet.Font))
                                    {
                                        ...
                                        fontSL.FromFont((DocumentFormat.OpenXml.Spreadsheet.Font)oxrFont.LoadCurrentElement());
        ...
        internal void WriteStylesheet()
        {
            ...
            if (wbp.WorkbookStylesPart != null)
            {
                ...
                if (listStyleFont.Count > countStyleFont)
                {
                    ...
                    for (i = 0; i < diff; ++i)
                    {
                        wbsp.Stylesheet.Fonts.Append(new DocumentFormat.OpenXml.Spreadsheet.Font() { InnerXml = listStyleFont[i + countStyleFont] });
                    }
                }
