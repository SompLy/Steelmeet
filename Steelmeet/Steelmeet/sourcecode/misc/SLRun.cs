...
namespace SpreadsheetLight
{
    ...
    public class SLRun
    {
        ...
        internal void FromRun(Run r)
        {
            ...
            using (OpenXmlReader oxr = OpenXmlReader.Create(r))
            {
                while (oxr.Read())
                {
                    ...
                    else if (oxr.ElementType == typeof(DocumentFormat.OpenXml.Spreadsheet.FontFamily))
                    {
                        DocumentFormat.OpenXml.Spreadsheet.FontFamily ff = (DocumentFormat.OpenXml.Spreadsheet.FontFamily)oxr.LoadCurrentElement();
                    ...
                    {
                        this.Font.clrFontColor.FromSpreadsheetColor((DocumentFormat.OpenXml.Spreadsheet.Color)oxr.LoadCurrentElement());
        ...
        internal Run ToRun()
        {
            ...
            {
                r.RunProperties.Append(new DocumentFormat.OpenXml.Spreadsheet.FontFamily() { Val = this.Font.FontFamily.Value });
            }
